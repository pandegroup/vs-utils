...
# TODO(bramsundar): Make the physical constants scattered througout
# the code global variables defined at the top of the file.
...
class binana:
  ...
  components:
    ...
    -rotateable_bonds_count: Count of (ligand(?), receptor(?))
       rotateable bonds.
  """
  ...
  def compute_hydrophobic_contact(self, ligand_atom, receptor_atom):
  ...
  def compute_input_vector(self):
    ...
    rotateable_bonds_count = {'rot_bonds': data['rotateable_bonds_count']}
    ...
    input_vector = extend_list_by_dictionary(
        input_vector, rotateable_bonds_count)
    return input_vector
