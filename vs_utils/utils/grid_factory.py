...
class GridGenerator:
	...
	def initialize_grid(self):
		...
		'''
		Deprecated, dictionary style grid code. Will delete upon Bharath's command.
	...
	def featurize_atoms(self):
		for index, atom in self.box.all_atoms.iteritems():
			...
			#print(atom_features)
			#print("atomname = %s, element = %s, residue = %s" %(atomname, element, resname))
	...
	'''
	Deprecated method for old, dictionary-style way of storing features
